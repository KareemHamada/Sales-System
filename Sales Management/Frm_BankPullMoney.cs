...
{
    public partial class Frm_BankPullMoney : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("لا يمكن سحب قيمه اكبر من الموجوده فى البنك", "تاكيد"); 
                return;
            }
            db.executeData("update Bank set Money=Money - " + NudPrice.Value + " ", "", "");
            db.executeData("insert into Bank_Pull ( Money ,Date ,Name ,Type ,Reason) values (" + NudPrice.Value + " ,N'" + d + "' ,N'" + txtName.Text + "' ,N'سحب يدوي', N'" + txtreason.Text + "') ", "تم السحب بنجاح", "");
            onLoadScreen();
        }
    }
}
