...
{
    public partial class Frm_EmployeeBorrowMoneyReport : Form
    {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                db.executeData("delete from Employee_BorrowMoney where Convert(date,[Order_Date] ,105 ) between '" + date1 + "' and '" + date2 + "'", "تم مسح البيانات بنجاح", "");
