...
{
    public partial class Frm_EmployeeBorrowItemsReport : Form
    {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                db.executeData("delete from Employee_BorrowItems where Convert(date,[Date] ,105 ) between '" + date1 + "' and '" + date2 + "'", "تم مسح البيانات بنجاح", "");
