...
{
    public partial class Frm_BankAddMoney : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            db.executeData("insert into Bank_Insert ( Money ,Date ,Name ,Type ,Reason) values (" + NudPrice.Value + " ,N'" + d + "' ,N'" + txtName.Text + "' ,N'رصيد اضافى', N'" + txtreason.Text + "') ", "تم الايداع بنجاح", "");
            onLoadScreen();
        }
    }
}
