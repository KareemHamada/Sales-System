...
{
    public partial class Frm_BankPullMoneyReport : Form
    {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                db.executeData("delete from Bank_Pull where Convert(date,Date ,105 ) between '" + date1 + "' and '" + date2 + "'", "تم مسح البيانات بنجاح", "");
                //tbl.Clear();
                //DgvSearch.DataSource = tbl;
